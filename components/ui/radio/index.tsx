...
const radioStyle = tva({
  base: 'group/radio '+
        ...
        'items-center '+
        'web:cursor-pointer '+
        'data-[disabled=true]:web:cursor-not-allowed',
  variants: {
    size: {
      sm: 'gap-1.5',
      md: 'gap-2',
...
const radioLabelStyle = tva({
  base: 'text-typography-600 '+
        ...
        'data-[hover=true]:data-[disabled=true]:text-typography-600 '+
        'data-[hover=true]:data-[disabled=true]:data-[checked=true]:text-typography-900 '+
        'data-[active=true]:text-typography-900 data-[active=true]:data-[checked=true]:text-typography-900 '+
        'data-[disabled=true]:opacity-40 '+
        'web:select-none',
  parentVariants: {
    size: {

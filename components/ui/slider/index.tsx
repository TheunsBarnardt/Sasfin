...
const sliderStyle = tva({
  base: 'justify-center '+
        'items-center '+
        'data-[disabled=true]:web:opacity-40 '+
        'data-[disabled=true]:web:pointer-events-none',
  variants: {
    orientation: {
      horizontal: 'w-full',
      vertical: 'h-full',
...
const sliderThumbStyle = tva({
  base: 'bg-primary-500 '+
        'absolute '+
        'rounded-full '+
        'data-[focus=true]:bg-primary-600 '+
        'data-[active=true]:bg-primary-600 '+
        'data-[hover=true]:bg-primary-600 '+
        'data-[disabled=true]:bg-primary-500 '+
        'web:cursor-pointer '+
        'web:data-[active=true]:outline '+
        'web:data-[active=true]:outline-4 '+
        'web:data-[active=true]:outline-primary-400 '+
        'shadow-hard-1',

...
const selectTriggerStyle = tva({
  base: 'border '+
        ...
        'data-[disabled=true]:data-[hover=true]:border-background-300',
  variants: {
    size: {
      xl: 'h-12',
      lg: 'h-11',
    ...
    variant: {
      underlined:
        ...
        'data-[focus=true]:border-primary-700 '+
        'data-[focus=true]:web:shadow-[inset_0_-1px_0_0] '+
        'data-[focus=true]:web:shadow-primary-700 '+
        'data-[invalid=true]:border-error-700 '+
        'data-[invalid=true]:web:shadow-error-700',
      outline:
        'data-[focus=true]:border-primary-700 '+
        'data-[focus=true]:web:shadow-[inset_0_0_0_1px] '+
        'data-[focus=true]:data-[hover=true]:web:shadow-primary-600 '+
        'data-[invalid=true]:web:shadow-[inset_0_0_0_1px] '+
        'data-[invalid=true]:border-error-700 '+
        'data-[invalid=true]:web:shadow-error-700 '+

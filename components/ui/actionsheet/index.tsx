...
const actionsheetStyle = tva({ base: 
  'w-full '+
  'h-full '+
...
const actionsheetItemStyle = tva({
  base: 'w-full '+
        ...
        'data-[disabled=true]:web:pointer-events-auto '+
        'data-[disabled=true]:web:cursor-not-allowed '+
        'hover:bg-background-50 '+
        'active:bg-background-100 '+
        'data-[focus=true]:bg-background-100 '+
        'web:data-[focus-visible=true]:bg-background-100 '+
        'web:data-[focus-visible=true]:outline-indicator-primary '+
        'gap-2',
});

  ...
  variants: {
    ...
    variant: {
      underlined:
        'rounded-none '+
        'border-b '+
        'data-[invalid=true]:border-b-2 '+
        'data-[invalid=true]:border-error-700 '+
        'data-[invalid=true]:hover:border-error-700 '+
        'data-[invalid=true]:data-[focus=true]:border-error-700 '+
        'data-[invalid=true]:data-[focus=true]:hover:border-error-700 '+
        'data-[invalid=true]:data-[disabled=true]:hover:border-error-700',
      ...
      outline:
        ...
        'data-[invalid=true]:data-[focus=true]:hover:web:ring-1 '+
        'data-[invalid=true]:data-[focus=true]:hover:web:ring-inset '+
        'data-[invalid=true]:data-[focus=true]:hover:web:ring-indicator-error '+
        'data-[invalid=true]:data-[disabled=true]:hover:web:ring-1 '+
        'data-[invalid=true]:data-[disabled=true]:hover:web:ring-inset '+

...
const menuItemStyle = tva({
  base: 'min-w-[200px] '+
        ...
        'data-[focus=true]:bg-background-50 '+
        'data-[focus=true]:web:outline-none '+
        'data-[focus=true]:web:outline-0 '+
        ...
        'data-[focus-visible=true]:web:cursor-pointer '+
        'data-[disabled=true]:data-[focus=true]:bg-transparent',
});

...
const popoverArrowStyle = tva({
  ...
  variants: {
    placement: {
      'top left':
        'data-[flip=false]:border-t-transparent '+
        'data-[flip=false]:border-l-transparent '+
        'data-[flip=true]:border-b-transparent '+
        'data-[flip=true]:border-r-transparent',
      'top':
        'data-[flip=false]:border-t-transparent '+
        'data-[flip=false]:border-l-transparent '+
        'data-[flip=true]:border-b-transparent '+
      ...
      'top right':
        ...
        'data-[flip=true]:border-r-transparent',
      'bottom':
        'data-[flip=false]:border-b-transparent '+
        'data-[flip=false]:border-r-transparent '+
        'data-[flip=true]:border-t-transparent '+
        'data-[flip=true]:border-l-transparent',
      'bottom left':
        'data-[flip=false]:border-b-transparent '+
        'data-[flip=false]:border-r-transparent '+
        'data-[flip=true]:border-t-transparent '+
...
const popoverCloseButtonStyle = tva({
  base: 'group/popover-close-button '+
        'z-[1] '+
        'rounded-sm '+
        'data-[focus-visible=true]:web:bg-background-100 '+
        'web:outline-0 '+
        'web:cursor-pointer',
});

...
const linkStyle = tva({
  base: 'group/link '+
        ...
        'data-[focus-visible=true]:web:ring-indicator-primary '+
        'data-[focus-visible=true]:web:outline-0 '+
        'data-[disabled=true]:opacity-4 ',
});

const linkTextStyle = tva({
  base: 'underline '+
        'text-info-700 '+
        'data-[hover=true]:text-info-600 '+
        'data-[hover=true]:no-underline '+
        'data-[active=true]:text-info-700 '+
        'font-normal '+
        'font-body '+
        'web:font-sans '+
        'web:tracking-sm '+
